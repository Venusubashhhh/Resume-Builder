...
import { defaultStrengths, strengthsSchema } from "@reactive-resume/schema";
import {
  Badge,
  BadgeInput,
  FormControl,
...
const formSchema = strengthsSchema;

type FormValues = z.infer<typeof formSchema>;

export const StrengthsDialog = () => {
  const form = useForm<FormValues>({
    defaultValues: defaultStrengths,
